...
面向 OpenWrt 旁路由与 Linux 服务端的 TUIC 外层 FEC、限速整形和多 WARP 分流方案。项目不修改 sing-box/TUIC 源码：UDP 会话经过带认证的 Reed-Solomon FEC 隧道；服务端 TCP 新连接轮询分配到三个 WARP，UDP 固定到一个稳定 WARP。
